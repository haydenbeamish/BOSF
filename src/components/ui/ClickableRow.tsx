...
/**
 * A keyboard- and pointer-accessible clickable row.
 * Centralises the role="button" + tabIndex=0 + onKeyDown pattern used across
 * RankRow, Podium, EventsPage, PlayerPage, etc.
 */
